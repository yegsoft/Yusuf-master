...
public class GeoMain extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public static Intent makeNotificationIntent(Context context, String msg) {
        Intent intent = new Intent(context, GeoMain.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctx = this;
        setContentView(R.layout.geoactivitylayout);
        createGoogleApi();
